                     ...
                     <div className="space-y-2">
                        ...
                        <div className="space-y-2 w-full mb-7">
                            ...
                            <div className="space-y-3">
                                ...
                                {/* Add button only if last feature is not empty */}
                                {values.features[values.features.length - 1].name.trim() !== "" && (
                                    <Button
                                        type='text'
                                        size="small"
                                        icon={<Plus className="w-4 h-4" />}
                                        onClick={(e) => {
                                            e.preventDefault();
                                            setFieldValue("features", [...values.features, { name: "" }]);
                                        }}
                                        className="!w-fit !h-fit !px-3 !py-2 mt-2 border !border-border-primary"
                                    >
                                        Add Feature
                                    </Button>
                                )}
