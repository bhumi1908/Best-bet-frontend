        ...
        <section className="relative px-4 py-24">
          <div className="max-w-7xl mx-auto w-full">
            ...
            >
              ...
              >
                About <span className="text-yellow-400">Best Bet</span>
              </motion.h1>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              {[
                ...
                >
                  <motion.div
                    className="w-12 h-12 rounded-xl bg-gradient-to-br from-yellow-400/20 to-yellow-500/20 flex items-center justify-center mb-4 text-yellow-400"
